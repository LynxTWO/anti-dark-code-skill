...
- [x] Acceptance coverage: all 51 S-ids name a registered R-id. Forty-nine rest on collected test nodes. S-014 and S-050 rest on R-053 mutation evidence, a typed evidence class accepted by the traceability checker. The current Windows suite reported `425 passed, 14 skipped, 48 subtests passed`.
