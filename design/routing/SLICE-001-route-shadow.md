...
- [~] Platform execution is split from acceptance coverage. PR 23 commit `157f10a1b2f0bc1c65e3e1ea92ed49d37316c987` passed Linux, macOS, and Windows, plus Python 3.13, in required run `33402328694`. The round-fourteen delta after that run has the Windows suite result above and Linux and Windows M92 replay; no new macOS run covers that delta.
