...
- [~] D-026 through D-047 are resolved in code. The executable evidence map covers R-001 through R-055. D-071 and D-072 close the four partial M3 requirements with collected tests; R-013, R-018, and R-022 are traced to collected runner tests.
