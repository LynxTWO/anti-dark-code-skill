...
| Native/dynamic availability, dead-code or physical-client handoff claim | [Reachability](specialist-native-reachability.md): complete graph/target chain; distinguish server readiness, client endpoint acquisition and observed target identity. |
